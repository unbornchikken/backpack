...
Serializer.prototype._registerDefaultKnownTypes = function () {
    ...
    this.registerKnownType("Int8Array", Int8Array);
    this.registerKnownType("Uint8Array", Uint8Array);
    this.registerKnownType("Uint8ClampedArray", Uint8ClampedArray);
    this.registerKnownType("Int16Array", Int16Array);
    this.registerKnownType("Uint16Array", Uint16Array);
    this.registerKnownType("Int32Array", Int32Array);
    this.registerKnownType("Uint32Array", Uint32Array);
    this.registerKnownType("Float32Array", Float32Array);
    this.registerKnownType("Float64Array", Float64Array);
};
...
Serializer.prototype._serialize = function (obj, cache, path) {
    if (typeof obj === "object") {
        ...
        if (obj instanceof RegExp) {
            ...
            let data = { source: source, flags: obj.toString().substr(source.length + 2) };
            obj = data;
            toJSON = true;
        }
...
Serializer.prototype.fromJSON = function (json) {
    ...
    let result = this._unserialize(json);
    if (fun) {
        result = result.f;
    }
    return result;
        ...
        if (result !== null) {
            if (fromJSON) {
                ...
                if (type === "Map") {
                    ...
                    let typedArray = new Int8Array(result.data);
                    return typedArray;
                }
                else if (type === "Uint8Array") {
                    let typedArray = new Uint8Array(result.data);
                    return typedArray;
                }
                else if (type === "Uint8ClampedArray") {
                    let typedArray = new Uint8ClampedArray(result.data);
                    return typedArray;
                }
                else if (type === "Int16Array") {
                    let typedArray = new Int16Array(result.data);
                    return typedArray;
                }
                else if (type === "Uint16Array") {
                    let typedArray = new Uint16Array(result.data);
                    return typedArray;
                }
                else if (type === "Int32Array") {
                    let typedArray = new Int32Array(result.data);
                    return typedArray;
                }
                else if (type === "Uint32Array") {
                    let typedArray = new Uint32Array(result.data);
                    return typedArray;
                }
                else if (type === "Float32Array") {
                    let typedArray = new Float32Array(result.data);
                    return typedArray;
                }
                else if (type === "Float64Array") {
                    let typedArray = new Float64Array(result.data);
                    return typedArray;
                }
                else if (type === "Date") {
