...
{
    this.registerKnownType("backpack.collections.Map", require("../../").collections.Map);
    this.registerKnownType("backpack.collections.StrMap", require("../../").collections.StrMap);
    this.registerKnownType("backpack.collections.Set", require("../../").collections.Set);
    this.registerKnownType("backpack.collections.StrSet", require("../../").collections.StrSet);
    this.registerKnownType("backpack.collections.Bag", require("../../").collections.Bag);
    this.registerKnownType("backpack.collections.StrBag", require("../../").collections.StrBag);
}
...
Serializer.prototype._unserialize = function (obj, originObj, circularTasks)
{
    if (typeof obj === "object")
    {
        ...
        if (obj !== null)
        {
            ...
            for (var key in obj)
            {
                if (obj.hasOwnProperty(key) && key != Serializer.TOJSONTAG)
                {
                    var subObject = obj[key];
